      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?php echo base_url(); ?>dist/index">Polsek Cibarusah</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="<?php echo base_url(); ?>dist/index">PC</a>
          </div>
          <ul class="sidebar-menu">
            
            <li class="menu-header">Dashboard</li>
            <li class="<?php echo $this->uri->segment(2) == '' || $this->uri->segment(2) == 'admin' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin"><i class="fas fa-fire"></i> <span>Dashboard</span></a></li>

            <li class="menu-header">Layanan</li>
            <li class="dropdown <?php echo $this->uri->segment(2) == 'laporan_pengaduan' || $this->uri->segment(2) == 'lihat_pengaduan' || $this->uri->segment(2) == 'tinjau_pengaduan' ? 'active' : ''; ?>">
              <a href="<?= base_url('admin/laporan_pengaduan') ?>" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-file"></i> <span>Laporan Pengaduan</span></a>
              <ul class="dropdown-menu">
                <li class="<?php echo $this->uri->segment(2) == 'laporan_pengaduan' || $this->uri->segment(2) == 'lihat_pengaduan' || $this->uri->segment(2) == 'tinjau_pengaduan' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin/laporan_pengaduan">Laporan Pengaduan</a></li>
              </ul>
            </li>
